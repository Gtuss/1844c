...
# Add key
plt.text(0.85, 0.05, "Key", transform=plt.gca().transAxes, fontsize=12, bbox=dict(facecolor='white', edgecolor='black'))
plt.text(0.85, 0.01, "____ Piccadilly", transform=plt.gca().transAxes, fontsize=10)
